...
const countrys = {};
places.result[1].forEach(place => {
  if (place.id.slice(-2) !== '00') {
    countrys['C' + place.id] = {
      name: place.fullname,
...
console.log(
  JSON.stringify(countrys, (key, value) => {
    console.log(key);
    console.log(value);
  }),
);
...
// var fs = require('fs');
// var fileDirectory = 'd:\\country.json';
// var fileObj = fs.readFileSync(fileDirectory);
// fs.writeFileSync(fileObj, JSON.stringify(countrys));
